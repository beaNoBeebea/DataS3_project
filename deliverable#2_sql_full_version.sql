...
CREATE TABLE Clinical_Activity (
  ...
  IID INT NOT NULL,
  EX_ID CHAR(11) NOT NULL, -- ALL OF THESE ARE ONE-TO-MANY RELATIONSHIPS EXCEPT THE LAST ONE WHICH IS ONE-TO-ONE
...
CREATE TABLE Prescription(
  ...
  Date_Issued date,
  CAID CHAR(11) UNIQUE NOT NULL,  -- ONE-TO-MANY + THE AT-MOST-ONE CONSTRAINT
  FOREIGN KEY (CAID) REFERENCES Clinical_Activity(CAID)
);

CREATE TABLE Medication (
  DrugID CHAR(11) PRIMARY KEY,
  Name VARCHAR(50),
  Class VARCHAR(50),
  Form VARCHAR(50),
  Strength VARCHAR(50),
...
CREATE TABLE Has_Contact_Location( IID INT,
                                   CLID CHAR(11),
...
CREATE TABLE Insurance_Covers(  InsID CHAR(11),
                                IID INT,
...
CREATE TABLE Work_In(   STAFF_ID CHAR(11)  , 
                        DEP_ID CHAR(11) , 
                        PRIMARY KEY (STAFF_ID,DEP_ID),
                        FOREIGN KEY (STAFF_ID) REFERENCES Staff(STAFF_ID),
                        FOREIGN KEY (DEP_ID) REFERENCES Department(DEP_ID)
                        );    -- WE CANNOT MODEL THE TOTAL PARTICIPATION CONSTRAINT
...
('CA1', '2025-10-12', '10:00:00', 'Scheduled', 'D1', 'S1', 1),
('CA2', '2025-10-13', '11:30:00', 'Completed', 'D2', 'S2', 2),
('CA3', '2025-10-14', '09:15:00', 'Scheduled', 'D3', 'S3', 3);
